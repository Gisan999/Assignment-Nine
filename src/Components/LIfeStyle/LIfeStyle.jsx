               ...
               <div  data-aos="flip-left"className='items-center px-5 md:px-0 '>
                ...
                <div className='flex justify-center p-5 md:p-0'>
                    <div>
                        ...
                        <div><img className='w-32 md:w-64 lg:w-80 h-16 md:h-20 lg:h-24  border-4 md:border-8 border-white rounded-tl-[40px] md:rounded-tl-[100px] rounded-br-[40px] md:rounded-br-[100px] shadow-lg relative bottom-[125px] md:bottom-[250px] lg:bottom-[300px] left-[200px] md:left-[245px] lg:left-[290px] hover:scale-110 transition duration-500 cursor-pointer' src={photo3} alt="" /></div>
                    </div>
