import footer from '../../assets/background3.png'
    ...
    return (
        <div style={{
            ...
            <div className='max-w-screen-xl mx-auto'>
                <footer className="footer footer-center p-10 py-20 ">
                    <aside>
                        ...
                        <p className="font-bold py-7">
                        <a className=" uppercase font-serif text-xl font-extrabold">Event  <sup className="text-2xl text-sky-500">H</sup> orizon</a> Industries Ltd. <br /> <br />Providing We have been making people happy since 2012
                        </p>
